    ...
    return (
      <div className="flex flex-col items-center justify-center h-screen w-full text-white px-4">
        <div className="w-full max-w-xs flex flex-col items-center">
          ...
          <h1 className="text-xl font-bold mt-4 text-center">SmartRide</h1>
          ...
          <div className="mt-6 w-full flex flex-col gap-3">
            <Link to="/login">
              <button className="px-4 py-2 bg-black hover:bg-gray-800 text-black text-sm font-semibold rounded-md shadow transition w-full">
                Go to Login
              </button>
            </Link>
